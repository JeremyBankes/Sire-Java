...
public class KeyInput {
	...
	private LinkedHashSet<KeyEventCallback> keyCallbacks;
	private HashSet<Integer> pressed;

	public KeyInput(GameWindow window) {
		doubleTaps = new HashMap<>();
		keyCallbacks = new LinkedHashSet<>();
		pressed = new HashSet<>();
		...
		canvas.addKeyListener(new KeyListener() {
			...
			public void keyTyped(KeyEvent awtEvent) {
				String modifiers = KeyEvent.getModifiersExText(awtEvent.getModifiersEx()).toLowerCase();
			...
			public void keyReleased(KeyEvent awtEvent) {
				...
				String modifers = KeyEvent.getModifiersExText(awtEvent.getModifiersEx());
			...
			public void keyPressed(KeyEvent awtEvent) {
				...
				String modifiers = KeyEvent.getModifiersExText(awtEvent.getModifiersEx());
